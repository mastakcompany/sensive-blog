...
class PostQuerySet(models.QuerySet):
    ...
    def prefetch_tags(self):
        prefetch_tags = self.prefetch_related(Prefetch('tags', queryset=Tag.objects.popular_tags()))
        return prefetch_tags
    
    def fetch_with_comments_count(self):
        """
        This feature helps to avoid using two annotate expressions in the same query.
        """
